...
struct _CAR_STATUS {
	...
	glm::mat4 Matrix_CAR_WHEEL_ROLL;
	glm::mat4 Matrix_CAR_WHEEL_ROT;
...
void update_car_front_wheel_rotate_matrix(void) {
	...
	car_status.Matrix_CAR_WHEEL_ROT= glm::rotate(glm::mat4(1.0f),
		TO_RADIAN*car_status.front_wheel_turn_angle, glm::vec3(0.0f, 1.0f, 0.0f));
	...
	car_status.Matrix_CAR_WHEEL_ROLL=glm::rotate(glm::mat4(1),
		TO_RADIAN*car_status.front_wheel_roll_angle, glm::vec3(0.0f, 0.0f, 1.0f));
}
...
void initialize_car(void) {
	...
	car_status.pos.z = car_status.pos.x = 0.0f;
	car_status.pos.y = 0.0f;
	car_status.dir.z = car_status.dir.y = 0;
	car_status.dir.x = 1.0f;
...
void draw_wheel_and_nut() {
	...
	for (int i = 0; i < 5; i++) {
		...
		ModelViewProjectionMatrix = ViewProjectionMatrix[camera_selected] * ModelMatrix_CAR_NUT;
...
void draw_car(void) {
	...
	ModelViewProjectionMatrix = ViewProjectionMatrix[camera_selected] * ModelMatrix_CAR_DRIVER;
	glUniformMatrix4fv(loc_ModelViewProjectionMatrix, 1, GL_FALSE, &ModelViewProjectionMatrix[0][0]);
	glLineWidth(5.0f);
	...
	ModelViewProjectionMatrix = ViewProjectionMatrix[camera_selected] * ModelMatrix_CAR_WHEEL;
	glUniformMatrix4fv(loc_ModelViewProjectionMatrix, 1, GL_FALSE, &ModelViewProjectionMatrix[0][0]);
	draw_wheel_and_nut();  // draw wheel 0

	ModelMatrix_CAR_WHEEL = glm::translate(ModelMatrix_CAR_BODY, glm::vec3(3.9f, -3.5f, 4.5f));
	ModelMatrix_CAR_WHEEL *= car_status.Matrix_CAR_WHEEL_ROLL;
	ModelViewProjectionMatrix = ViewProjectionMatrix[camera_selected] * ModelMatrix_CAR_WHEEL;
	glUniformMatrix4fv(loc_ModelViewProjectionMatrix, 1, GL_FALSE, &ModelViewProjectionMatrix[0][0]);
...
void draw_oo(void) {
	...
	H_OBJ_W1 = glm::translate(H_OBJ_B, glm::vec3(4, 0, 4));
	H_OBJ_W1 *= car_status.Matrix_CAR_WHEEL_ROTATE;
	ModelViewProjectionMatrix = ViewProjectionMatrix[camera_selected] * H_OBJ_W1;
	glUniformMatrix4fv(loc_ModelViewProjectionMatrix, 1, GL_FALSE, &ModelViewProjectionMatrix[0][0]);
	draw_cir();

	H_OBJ_W2 = glm::translate(H_OBJ_B, glm::vec3(-4, 0, 4));
	H_OBJ_W2 *= car_status.Matrix_CAR_WHEEL_ROTATE;
	ModelViewProjectionMatrix = ViewProjectionMatrix[camera_selected] * H_OBJ_W2;
	glUniformMatrix4fv(loc_ModelViewProjectionMatrix, 1, GL_FALSE, &ModelViewProjectionMatrix[0][0]);
	draw_cir();

	H_OBJ_W3 = glm::translate(H_OBJ_B, glm::vec3(-4, 0, -4));
	H_OBJ_W3 *= car_status.Matrix_CAR_WHEEL_ROTATE;
	ModelViewProjectionMatrix = ViewProjectionMatrix[camera_selected] * H_OBJ_W3;
	glUniformMatrix4fv(loc_ModelViewProjectionMatrix, 1, GL_FALSE, &ModelViewProjectionMatrix[0][0]);
	draw_cir();

	H_OBJ_W4 = glm::translate(H_OBJ_B, glm::vec3(4, 0, -4));
	H_OBJ_W4 *= car_status.Matrix_CAR_WHEEL_ROTATE;
	ModelViewProjectionMatrix = ViewProjectionMatrix[camera_selected] * H_OBJ_W4;
	glUniformMatrix4fv(loc_ModelViewProjectionMatrix, 1, GL_FALSE, &ModelViewProjectionMatrix[0][0]);
	draw_cir();
}
void update_HOBJ_front_wheel_rotate_matrix(void) {
	H_OBJ_W_ROLL = glm::rotate(glm::mat4(1.0f),
		TO_RADIAN*car_status.front_wheel_turn_angle, glm::vec3(0.0f, 1.0f, 0.0f));
}